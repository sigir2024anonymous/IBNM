...
def domainnet_load_idx(args):
    train_bs = args.batch_size

    if args.dataset == 'DomainNet':
        assert args.class_num == 7
        ss = args.dset.split('2')[0]
        tt = args.dset.split('2')[1]
        if ss == 'i':
            s = 'infograph'
        ...
        s_tr_path = './data_split/domainnet/'+s+'_train.txt'
        s_ts_path = './data_split/domainnet/' + s + '_test.txt'
        t_tr_path = './data_split/domainnet/' + t + '_train.txt'
        t_ts_path = './data_split/domainnet/' + t + '_test.txt'
