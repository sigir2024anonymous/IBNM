cd ../
dataset='office_home'; class_num=65; cluster_num=65; tasks='p2r' #a2c a2p p2r #a2c a2p a2r c2p c2r p2r' #c2r c2p p2r' #'a2c a2p a2r c2a c2p c2r p2a p2c p2r r2a r2c r2p'
#dataset='DomainNet'; class_num=7; cluster_num=100; tasks='q2r' 
