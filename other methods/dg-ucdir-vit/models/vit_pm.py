...
class Vit(VisionTransformer):
    def __init__(self, img_size=224, patch_size=16, in_chans=3, num_classes=1000, embed_dim=768, depth=12,
        ...
        #self.my_fc_head = Mlp(self.num_features, hidden_features=self.num_features*2, out_features=self.num_classes, act_layer=nn.GELU, drop=.2)
...
class PMTrans(nn.Module):
    ...
    def __init__(self, num_classes=65, model_name='swin_base'):
        ...
        # pretrained=False  
        self.backbone = create_model(model_name, pretrained=False)
